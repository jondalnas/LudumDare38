...
public class Main extends Canvas implements Runnable {
	...
	public Main() {
		...
		try {
			icons.add(ImageIO.read(Main.class.getResourceAsStream("/tex/Icon16x16.png")));
			icons.add(ImageIO.read(Main.class.getResourceAsStream("/tex/Icon32x32.png")));
			icons.add(ImageIO.read(Main.class.getResourceAsStream("/tex/Icon64x64.png")));
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static void main(String[] args) {
		...
		JFrame frame = new JFrame("Live or DIE!");
